    ...
    <div class="menu mx-5" style="width: 80vw; height: 100vh;">
      ...
      <table id="menukasir" class="table  mt-4 table-bordered" style="width:100%">
        ...
        <tbody>
          ...
          <tr>
            <td><img src="file/{{$kasir->foto}}" alt="" width="30%"> </td>
            <td>{{$kasir->nama_produk}}</td>
            <td>{{$kasir->harga_produk}}</td>
            <td>{{$kasir->stok_produk}}</td>
            <td>
              <div class="col-auto  align-items-center" style="margin-left: 25%;">
                <button type="button" class="btn  mb-0" id="buttonSunting" data-id="{{$kasir->id}}" data-bs-toggle="modal" data-bs-target="#popupsuntingmenu" style="background-color: white; color: rgba(211, 36, 43, 1); border: 1px solid rgba(211, 36, 43, 1);">Sunting</button>
                <button type="button" class="btn mb-0 " id="buttonHapus" data-id="{{ $kasir->id }}" data-bs-toggle="modal" data-bs-target="#popuphapusmenu" style="background-color:rgba(211, 36, 43, 1); color: white;">Hapus</button>
              </div>
            </td>
          </tr>
          @endforeach
          ...
          <div class="modal-body">
            <form action="/kasir" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm">
                  <input type="file" class="form-control" id="foto" name="tambahFotoProduk">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm">
                  <input type="text" class="form-control" id="nama_produk" name="tambahNamaProduk">
                </div>
              </div>

              <div class="row mb-3">
                <label for="harga_produk" class="col-sm-4 col-form-label">Harga Produk(Rp)</label>
                <div class="col-sm">
                  <input type="number" class="form-control" id="harga_produk" name="tambahHargaProduk">
                </div>
              </div>

              <div class="row mb-3">
                <label for="stok_produk" class="col-sm-4 col-form-label">Stok Produk</label>
                <div class="col-sm">
                  <input type="number" class="form-control" id="stok_produk" name="tambahStokProduk">
                </div>
              </div>
          </div>
          <div class="modal-footer">
            <input type="submit" class="btn mb-0 " id="buttonTambahkan" value="Tambahkan" style="background-color:rgba(211, 36, 43, 1); color: white; margin-left: 80%;"></input>
          </div>
          </form>
        </div>
      </div>
          ...
          <form action="/kasir" id="suntingForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm">
                  <input type="number" class="form-control" id="suntingStokProduk" name="suntingStokProduk">
                </div>
              </div>
              <div class="modal-footer">
                <button type="submit" class="btn mb-0 " id="buttonSuntingUbah" style="background-color:rgba(211, 36, 43, 1); color: white; margin-left: 80%;">Sunting</input>
              </div>
          </form>
        </div>
      </div>
