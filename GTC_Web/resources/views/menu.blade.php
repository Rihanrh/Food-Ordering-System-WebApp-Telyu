                            ...
                            <td>
                                <div class="col-auto  align-items-center" style="margin-left: 25%;">
                                    <button type="button" class="btn  mb-0" id="buttonSunting"
                                        data-id="{{ $kasir->id }}" data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="mb-4 mt-4"
                            style="color: rgba(211, 36, 43, 1); font-weight: bold; margin-top: 2px; ">Tambah Menu</h3>
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn mb-0 " id="buttonTambahkan" value="Tambahkan"
                            style="background-color:rgba(211, 36, 43, 1); color: white; margin-left: 80%;"></input>
                    </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade modal-lg" id="popupsuntingmenu">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="mb-4 mt-4"
                            style="color: rgba(211, 36, 43, 1); font-weight: bold; margin-top: 2px; ">Sunting Menu</h3>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn mb-0 " id="buttonSuntingUbah"
                                    style="background-color:rgba(211, 36, 43, 1); color: white; margin-left: 80%;">Sunting</input>
                            </div>
                    </form>
                </div>
            </div>
